    ...
    return (
        <FooterContainer>
            <FooterContent>
                <FooterContacts>
                    <h3>Contacts</h3>
                    <a href="tel:+380932872580" style={{color: 'var(--main)', textDecoration: 'none'}}>
                        +38 (093) 287-25-80
                    </a>
                    <br/>
                    <a href="mailto:harmony.studio@gmail.com" style={{color: 'var(--main)', textDecoration: 'none'}}>
            ...
            <FooterCopyright>
                © 2024 Harmony Studio. All rights reserved.
            </FooterCopyright>
        </FooterContainer>
    );
};
